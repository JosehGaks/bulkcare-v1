        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              We specialize in providing comprehensive customer support outsourcing services designed to meet the diverse needs of businesses across various industries.
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <Link
                    href="/services/content-control-and-verification"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                ...
                <li>
                  <Link
                    href="/services/digital-customer-experience"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <Link
                    href="/industries/saas-and-software"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    Saas and Software
                  </Link>
                ...
                <li>
                  <Link
                    href="/industries/gaming-and-entertainment"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                ...
                <li>
                  <Link
                    href="/industries/on-demand-services"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    On Demand Services
                  </Link>
