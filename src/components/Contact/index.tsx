      ...
      <div className="container px-4">
        <div className="-mx-4 flex flex-wrap items-center">
              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      info@bulkcare.africa
                    </p>
                    <p className="mt-1 text-base text-body-color dark:text-dark-6">
                      contact@bulkcare.africa
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div
              className="wow fadeInUp rounded-lg px-8 py-10 shadow-testimonial dark:bg-dark-2 dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]"
              data-wow-delay=".2s
              "
            >
              ...
              <form>
                ...
                <div className="mb-0">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded-md bg-primary px-10 py-3 text-base font-medium text-white dark:text-black transition duration-300 ease-in-out hover:bg-primary/90"
                  >
                    Send
                  </button>
                </div>
