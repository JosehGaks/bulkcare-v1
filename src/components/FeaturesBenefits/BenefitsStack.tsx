  ...
  return (
    <div className="pt-32 container mx-auto">
      ...
      <p className="max-w-3xl text-2xl/8 font-medium tracking-tight mt-2 bg-gradient-to-br from-black/90 to-black/80 bg-clip-text text-transparent dark:from-white dark:to-white/40">
        Empower your business with exceptional customer support outsourcing.
      </p>
      <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
        <BentoCard
          eyebrow="Insight"
          title="Comprehensive Customer Profiles"
          description="BulkCare leverages customer data to provide deep insights, helping you understand your customers' needs and preferences like never before."
          graphic={
        ...
        <BentoCard
          eyebrow="Efficiency"
          title="Streamlined Support Operations"
          description="Our advanced workflow optimizes response times and ensures your customers receive fast, reliable service across all channels."
          graphic={
        ...
        <BentoCard
          ...
          description="Enhance customer interactions with AI-driven tools that predict customer behavior and provide real-time assistance."
          graphic={
        ...
        <BentoCard
          ...
          description="BulkCare adapts to your company's growth, offering scalable solutions to meet the evolving needs of your customer support team."
          graphic={
        ...
        <BentoCard
          ...
          title="Support Your Customers Anywhere"
          description="Our global team ensures your customers are supported around the clock, no matter where they are."
          graphic={
