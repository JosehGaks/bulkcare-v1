  ...
  const tabs: tab[] = [
    {
      ...
      content:
        "Helpware creates personalized customer journeys by providing customized SaaS support teams across all channels. Our SaaS customer solutions provide call center, email, chat, digital, and technical outsourcing to create higher engagement and experience.Our support teams work 24/7 and are available where your customers are. to boost satisfaction and brand loyalty.In addition to delivering high-quality customer experiences, we provide the capability to scale no matter the size or volume of the project. Through best-in-class Integrations and people empowerment, Helpware offers the platform and process to maintain a competitive advantage.",
      action: "Get Started",
    },
    {
